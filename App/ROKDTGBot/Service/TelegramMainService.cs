    ...
    public class TelegramMainService : ITelegramMainService
    {
        ...
        private async Task<bool> HandleCallback(TelegramBotClient client, CallbackQuery? callbackQuery, CancellationToken token)
        {
            ...
            return data switch
            {
                ...
                "NewsSearchByNumberChoice" => await SendWithCheckRights(client, user, chatId.Value, callbackQuery.Id, RoleEnum.moderator,
                                        (cl, chId, userNews, tk) => SendNewsSearchByNumberChoiceHandle(cl, chId, user, userNews, tk), token),
                "NewsSearchByUserChoice" => await SendWithCheckRights(client, user, chatId.Value, callbackQuery.Id, RoleEnum.moderator,
                                        (cl, chId, userNews, tk) => SendNewsSearchByUserChoiceHandle(cl, chId, user, userNews, tk), token),
                ...
                "NewsSearchByNumber" => await SendWithCheckRights(client, user, chatId.Value, callbackQuery.Id, RoleEnum.moderator,
                                        (cl, chId, userNews, tk) => NewsSearchByNumberHandle(cl, userId, chId, userNews, tk), token),
                "NewsSearchByUser" => await SendWithCheckRights(client, user, chatId.Value, callbackQuery.Id, RoleEnum.moderator,
